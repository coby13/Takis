...
class TablesControllerTest < ActionController::TestCase
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post :create, table: { body: @table.body, height: @table.height, name: @table.name, width: @table.width }
    end
  ...
  test "should update table" do
    put :update, id: @table, table: { body: @table.body, height: @table.height, name: @table.name, width: @table.width }
    assert_redirected_to table_path(assigns(:table))
  end
